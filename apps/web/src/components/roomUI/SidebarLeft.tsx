...
>>>>>>> 523530d022b565422c55b753e85b16d550d8b33b
                                            ...
                                            <>
                                                {animShowAvatar && (() => {
                                                    ...
                                                    const isSelf = currentUser && (user.username === currentUser.username || user.displayName === currentUser.displayName);
                                                     let avatarSrc = user.profilePicture || `/avatars/neutral_1.png`;
                                                    if (isSelf) {
                                                        try {
                                        ...
                                        `}
                                                    ...
                                                    >{(() => {
                                                         let avSrc = user.profilePicture || user.avatar;
                                                         if (avSrc && (avSrc.startsWith('animated:') || avSrc.startsWith('gifnick::') || avSrc.startsWith('3d:'))) {
                                                             avSrc = undefined;
                                                         }
                                                         if (!avSrc) {
                                                             avSrc = generateGenderAvatar(user.displayName || user.username || '?');
                                                         }
                                                         return <img src={avSrc} alt="" style={{ width: '100%', height: '100%', borderRadius: '50%', objectFit: 'cover' }} />;
                                                     })()}</div>
