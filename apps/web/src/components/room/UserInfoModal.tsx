                        ...
                        <div style={{
                            ...
                            {(() => {
                                ...
                                if (!av || av.startsWith('animated:') || av.startsWith('gifnick::') || av.startsWith('3d:')) {
                                    return (
                                        <span style={{ fontSize: 16, fontWeight: 900, color: 'rgba(255,255,255,0.9)', textTransform: 'uppercase' }}>
                                            {(user.displayName || user.username || '?').charAt(0)}
                                        </span>
                                    );
                                }
                                return <img src={av} alt="" style={{ width: '100%', height: '100%', borderRadius: '8px', objectFit: 'cover' }} />;
                            })()}
                        </div>
                        <div>
                            <div style={{
